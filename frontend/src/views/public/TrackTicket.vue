  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <header class="bg-white shadow-sm">
      <div class="container mx-auto px-4 py-4">
        <router-link to="/" class="flex items-center gap-2 w-fit">
          ...
          <span class="font-bold text-xl text-gray-800">C-Team Ticketera</span>
        </router-link>
      </div>
    </header>
    ...
    <div v-else-if="error" class="container mx-auto px-4 py-24">
      <div class="max-w-md mx-auto text-center">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mb-2">Ticket no encontrado</h1>
        <p class="text-gray-600 mb-6">El enlace que utilizaste no es válido o ha expirado.</p>
        ...
        <div class="bg-white rounded-xl shadow-lg p-6 mb-6">
          ...
          <div class="grid md:grid-cols-3 gap-4 text-sm">
            <div>
              ...
              <p class="font-medium text-gray-800">{{ ticket.clientName }}</p>
            </div>
            <div>
            ...
            <div>
              ...
              <p class="font-medium text-gray-800">{{ formatDateTime(ticket.createdAt) }}</p>
            </div>
          </div>
        </div>
            ...
            <div class="bg-white rounded-xl shadow-lg p-6">
              ...
              <div class="space-y-3">
                ...
                >
                  ...
                  <div>
                    <p class="text-gray-800">{{ getHistoryText(entry) }}</p>
                    <p class="text-gray-400 text-xs">{{ formatDateTime(entry.createdAt) }}</p>
                  </div>
                </div>
              </div>
            </div>
