  ...
  <StaffLayout page-title="Feriados">
    <div class="max-w-3xl">
      ...
      <div class="flex items-center justify-between mb-6">
        <div>
          <p class="text-gray-600">Los feriados no se cuentan en el cálculo de SLA</p>
        </div>
        <button
        ...
        <div v-else class="divide-y">
          ...
          >
            <div class="w-16 h-16 bg-primary-100 rounded-lg flex flex-col items-center justify-center">
              <span class="text-2xl font-bold text-primary-600">{{ getDay(holiday.date) }}</span>
            ...
            <div class="flex-1">
              ...
              <p class="text-sm text-gray-500">
                ...
                <span v-if="holiday.isRecurring" class="ml-2 text-green-600">(Recurrente)</span>
              </p>
            </div>
