  ...
  <StaffLayout page-title="Respuestas Predefinidas">
    <div class="max-w-4xl">
      ...
      <div class="flex items-center justify-between mb-6">
        <p class="text-gray-600">Crea respuestas rápidas para usar en los tickets</p>
        <button
      ...
      <div class="bg-white rounded-xl shadow">
        <div v-if="loading" class="p-8 text-center">
          <svg class="w-10 h-10 animate-spin text-primary-600 mx-auto" fill="none" viewBox="0 0 24 24">
            ...
            <div class="flex items-start justify-between">
              <div class="flex-1">
                <div class="flex items-center gap-2 mb-1">
                  <h3 class="font-medium text-gray-800">{{ response.title }}</h3>
                  <span
                  ...
                  <span
                    ...
                    class="px-2 py-0.5 bg-green-100 text-green-600 text-xs rounded"
                  >
                    Global
                  </span>
                </div>
                <p class="text-sm text-gray-600 line-clamp-2">{{ response.content }}</p>
              </div>
    ...
    >
      <div class="bg-white rounded-xl shadow-xl max-w-lg w-full p-6">
        ...
        <form @submit.prevent="saveResponse">
          ...
          <div class="mb-4">
            <label class="block text-sm font-medium text-gray-700 mb-1">Atajo (opcional)</label>
          ...
          <div v-if="isAdmin" class="mb-4">
            <label class="flex items-center gap-2">
              ...
              />
              <span class="text-sm text-gray-700">Disponible para todos los agentes</span>
            </label>
          </div>
